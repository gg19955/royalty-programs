...
export const FAQ_ITEMS: FAQ[] = [
  ...
  },
  {
    ...
    a: "Every home is fitted with secure locks and many have alarm systems. Access codes are sent ahead of arrival so there's no need to coordinate keys in person.",
  },
  {
  ...
  {
    q: "What's nearby?",
    a: "Our properties are hand-picked for their location, meaning you're always minutes from the region's best restaurants, wineries, beaches, and attractions. Each listing includes a curated local guide.",
  },
  {
    q: "Where can I buy groceries or dine out?",
    a: "Each region has outstanding local grocers, providores, and restaurants. We include a personally-curated list of our favourite food and drink spots in the welcome guide for every property.",
  },
  {
  ...
  },
  {
    ...
    a: "Every home is fully stocked with fresh linen, plush towels, premium toiletries, tea, coffee, and pantry basics to help you settle in immediately.",
  },
  {
    q: "What if there's an emergency?",
    a: "A Lively concierge is available 24/7 throughout your stay. Contact details are shared ahead of arrival and included in the welcome guide.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Every Lively home is stocked with premium shampoo, conditioner, body wash, and hand soap. Some properties also include bath salts and additional amenities.",
  },
  {
  ...
  {
    q: "Are pets allowed?",
    a: "A select number of our homes are pet-friendly. Pet-friendly listings are clearly marked and may carry a small additional cleaning fee.",
  },
  {
    q: "What are the payment terms?",
    a: "A 50% deposit secures your booking, with the balance payable 30 days before arrival. Bookings made within 30 days of check-in are paid in full at the time of reservation.",
  },
];
